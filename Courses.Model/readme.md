...
2) Для применения миграции и создания бд на её основе выполняем команду `dotnet ef database update --project ./CourseBackend/Courses.Model --startup-project ./Api/Courses.AdminPanel.csproj`.